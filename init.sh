...
SDKBIN="https://github.com/sec/dotnet-core-freebsd-source-build/releases/download/8.0.100-preview.4-x64-native/dotnet-sdk-8.0.100-preview.4.23260.5-freebsd-x64.tar.gz"
SDKZIP="sdk.tgz"

if [ `uname -m` = 'arm64' ]; then
    SDKBIN="https://github.com/sec/dotnet-core-freebsd-source-build/releases/download/8.0.100-preview.4-arm64-native/dotnet-sdk-8.0.100-preview.4.23260.5-freebsd-arm64.tar.gz"
fi
