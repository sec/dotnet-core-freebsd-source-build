...
aspnetcore/eng/build.sh -ci --os-name freebsd --pack -c Release --all /p:TreatWarningsAsErrors=false /p:OfficialBuildId=`./common.sh $TAG` --arch $ARCH /p:SkipTestBuild=true
